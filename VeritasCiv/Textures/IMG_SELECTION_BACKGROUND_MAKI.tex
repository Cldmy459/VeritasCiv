...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Civ VI Mod\Veritas\Image\Background\IMG_SELECTION_BACKGROUND_MAKI.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1756508110</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="IMG_SELECTION_BACKGROUND_MAKI.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="IMG_SELECTION_BACKGROUND_MAKI"/>
	<m_Description text=""/>
	<m_Tags>
